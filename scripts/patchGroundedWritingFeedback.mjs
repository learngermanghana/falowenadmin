...
source = replaceOnce(
  ...
  `    const correctionIsAnchored = kind !== "next"\n      || !isCorrectiveWritingClaim(value)\n      || (quoted.length > 0 && quoted.some((quote) => normalizedSubmission.includes(quote.toLocaleLowerCase("de"))));`,
  "AI prose grounding",
);
