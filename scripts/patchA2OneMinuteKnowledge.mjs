...
if (!day19Block.includes('vocabularyCheckQuestions: [')) {
  ...
  const fields = `    grammarCheckQuestions: [
    ...
    vocabularyCheckModels: [
      { questionDe: "Du bekommst 20 % Preisnachlass. Wie heißt das Wort?", modelAnswerDe: "der Rabatt" }, { questionDe: "Du möchtest eine Ware zurückschicken. Wie heißt das Nomen?", modelAnswerDe: "die Rücksendung" }, { questionDe: "Du kaufst Produkte aus deiner Region. Welches Adjektiv passt?", modelAnswerDe: "regional" }, { questionDe: "Du möchtest beweisen, dass du bezahlt hast. Was brauchst du?", modelAnswerDe: "den Kassenbon / die Quittung" }, { questionDe: "Du kaufst bewusst weniger Plastik und faire Produkte. Wie heißt dieses Thema?", modelAnswerDe: "nachhaltiger Konsum" }
    ],
    sentenceBuilderQuestions: ["ich / online / kaufe / denn / bequem / es / ist", "bar / oder / möchtest / mit Karte / du / bezahlen", "ich / regionale Produkte / kaufe / denn / frisch / sie / sind", "das rote Hemd / oder / nimmst / das blaue Hemd / du"],
    sentenceBuilderModels: [
      { questionDe: "ich / online / kaufe / denn / bequem / es / ist", modelAnswerDe: "Ich kaufe online, denn es ist bequem." }, { questionDe: "bar / oder / möchtest / mit Karte / du / bezahlen", modelAnswerDe: "Möchtest du bar oder mit Karte bezahlen?" }, { questionDe: "ich / regionale Produkte / kaufe / denn / frisch / sie / sind", modelAnswerDe: "Ich kaufe regionale Produkte, denn sie sind frisch." }, { questionDe: "das rote Hemd / oder / nimmst / das blaue Hemd / du", modelAnswerDe: "Nimmst du das rote Hemd oder das blaue Hemd?" }
    ],
    guidedActionQuestions: ["Online oder im Geschäft? Entscheide dich und bilde einen Satz mit denn.", "Bar oder mit Karte? Entscheide dich und begründe mit denn.", "Neue oder gebrauchte Kleidung? Entscheide dich und begründe.", "Regionale oder importierte Produkte? Entscheide dich und begründe."],
    guidedActionModels: [
      { questionDe: "Online oder im Geschäft? Entscheide dich und bilde einen Satz mit denn.", modelAnswerDe: "Ich kaufe lieber im Geschäft, denn ich kann die Kleidung anprobieren." }, { questionDe: "Bar oder mit Karte? Entscheide dich und begründe mit denn.", modelAnswerDe: "Ich bezahle lieber mit Karte, denn das ist praktisch." }, { questionDe: "Neue oder gebrauchte Kleidung? Entscheide dich und begründe.", modelAnswerDe: "Ich kaufe manchmal gebrauchte Kleidung, denn das ist nachhaltiger." }, { questionDe: "Regionale oder importierte Produkte? Entscheide dich und begründe.", modelAnswerDe: "Ich kaufe regionale Produkte, denn die Transportwege sind kürzer." }
    ],
    rolePlayQuestions: ["Du möchtest eine Jacke kaufen. Frage nach zwei Farben, entscheide dich und begründe deine Wahl mit denn.", "Du kaufst Möbel mit einem Freund. Gib zwei Möglichkeiten mit oder und erkläre deine Präferenz mit denn.", "Du bist Verkäufer/in. Frage: bar oder mit Karte? Der Kunde antwortet und gibt einen Grund mit denn."],
    rolePlayModels: [
