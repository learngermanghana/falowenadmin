...
export const b1WorkbookAlignedSlidesDays11To20 = [
  ...
  },
  {
    ...
    teacherNotesEn: [
      ...
      "Important workbook exception: Teil 3 is Feldheim green-energy reading, and Teil 4 has no audio at all—it is a second reading about a tour through Murten's history.",
    ],
    interactionFlow: [
      ...
      { phase: "Workbook bridge", detailEn: "8 min: plan the Emma opinion and explicitly preview the two unrelated reading-based comprehension tasks." },
    ],
    ...
    workbookConnection: standardConnection(19, [
      ...
      { label: "Teil 3 · Lesen", detailEn: "Separate reading assignment: ‘Ein Dorf für grüne Energie’ about Feldheim, biogas, renewable energy, surplus electricity and the importance of active residents; answer questions 1–3." },
      { label: "Teil 4 · Hören", detailEn: "NO HÖREN MEDIUM was supplied. Teil 4 is actually a second reading task, ‘Tour durch Murtens Geschichte’, with questions 4–6. Submit those reading answer letters as Teil 4." },
    ], {
      subtitle: "Teach toward the workbook tasks, but note the Day 19 exception: Teil 4 has no audio and is a second Lesen task.",
    }),
    teacherSupport: {
      lessonOverviewEn: "Day 19 teaches interview register and professional self-presentation. The production lesson is coherent, but the workbook comprehension section deliberately/operationally shifts to two unrelated reading texts, including a Teil 4 slot with no audio.",
      grammarFocusEn: [
      ...
      commonMistakesEn: [
        ...
        "Trying to invent or play audio for Teil 4 instead of treating it as the second reading task supplied by the workbook.",
      ],
    },
  },
  {
